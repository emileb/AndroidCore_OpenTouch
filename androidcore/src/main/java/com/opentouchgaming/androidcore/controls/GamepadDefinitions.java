...
public class GamepadDefinitions
{
    ...
    static public ActionInputDefinition getDefinition(AppInfo.Apps app)
    {
        //if(gamepadDefinition == null)
        {
            ...
            if (app == AppInfo.Apps.RAZE_TOUCH)
            {
                gamepadDefinition.addHeader("Common");
                ...
                gamepadDefinition.addAction("map", "Map", ActionInput.ActionType.BUTTON, PortActDefs.PORT_ACT_MAP, ActionInput.SourceType.BUTTON, KeyEvent.KEYCODE_BUTTON_Y);
