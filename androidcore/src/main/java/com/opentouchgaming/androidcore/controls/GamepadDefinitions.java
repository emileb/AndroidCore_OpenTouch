    ...
    static public ActionInputDefinition getDefinition(AppInfo.Apps app)
    {
        //if(gamepadDefinition == null)
        {
            ...
            if(app == AppInfo.Apps.DELTA_TOUCH)
            {
                ...
                gamepadDefinition.addAction("attack", "Fire", ActionInput.ActionType.BUTTON, PortActDefs.PORT_ACT_ATTACK,
                        ActionInput.SourceType.AXIS, MotionEventCompat.AXIS_GAS);

                gamepadDefinition.addAction("use", "Open/Use", ActionInput.ActionType.BUTTON, PortActDefs.PORT_ACT_USE,
                ...
                gamepadDefinition.addAction("map", "Map", ActionInput.ActionType.BUTTON, PortActDefs.PORT_ACT_MAP,
                ...
                gamepadDefinition.addAction("show_utils", "Show Utils(Save,Load,Map,Keybrd etc)", ActionInput.ActionType.BUTTON, PortActDefs.PORT_ACT_SHOW_GP_UTILS,
                        ActionInput.SourceType.BUTTON, -1);

                gamepadDefinition.addAction("alt_attack", "Alt Attack (GZ)", ActionInput.ActionType.BUTTON, PortActDefs.PORT_ACT_ALT_ATTACK,
                        ActionInput.SourceType.BUTTON, -1);

                gamepadDefinition.addAction("jump", "Jump (GZ)", ActionInput.ActionType.BUTTON, PortActDefs.PORT_ACT_JUMP,
                        ActionInput.SourceType.BUTTON, -1);

                gamepadDefinition.addAction("crouch", "Crouch (GZ)", ActionInput.ActionType.BUTTON, PortActDefs.PORT_ACT_DOWN,
                        ActionInput.SourceType.BUTTON, -1);
                ...
                gamepadDefinition.addAction("reload", "Reload", ActionInput.ActionType.BUTTON, PortActDefs.PORT_ACT_RELOAD,
                        ActionInput.SourceType.BUTTON, -1);
            ...
            else if(app == AppInfo.Apps.QUAD_TOUCH)
            {
                ...
                gamepadDefinition.addAction("attack", "Attack", ActionInput.ActionType.BUTTON, PortActDefs.PORT_ACT_ATTACK,
                        ActionInput.SourceType.AXIS, MotionEvent.AXIS_GAS);
                ...
                gamepadDefinition.addAction("jump", "Jump/Swim up", ActionInput.ActionType.BUTTON, PortActDefs.PORT_ACT_JUMP,
                        ActionInput.SourceType.BUTTON, KeyEvent.KEYCODE_BUTTON_A);

                gamepadDefinition.addAction("crouch", "Crouch/Swim down", ActionInput.ActionType.BUTTON, PortActDefs.PORT_ACT_DOWN,
                        ActionInput.SourceType.BUTTON,  MotionEvent.AXIS_BRAKE);
                ...
                gamepadDefinition.addAction("show_utils", "Show Utils(Save,Load,Scores,Keybrd etc)", ActionInput.ActionType.BUTTON, PortActDefs.PORT_ACT_SHOW_GP_UTILS,
                        ActionInput.SourceType.BUTTON, -1);
                ...
                gamepadDefinition.addAction("use_item", "Use item (Q3)", ActionInput.ActionType.BUTTON, PortActDefs.PORT_ACT_USE,
                        ActionInput.SourceType.BUTTON, -1);
                ...
                gamepadDefinition.addAction("smd_use", "Use", ActionInput.ActionType.BUTTON, PortActDefs.PORT_SMD_USE,
                        ActionInput.SourceType.BUTTON, -1);
