...
public class OptionsFragment extends Fragment{
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		if ((AppSettings.game == GD.IDGame.Doom) || (AppSettings.game == GD.IDGame.Quake3)|| (AppSettings.game == GD.IDGame.RTCW)
				|| (AppSettings.game == GD.IDGame.Wolf3d)|| (AppSettings.game == GD.IDGame.JK2)|| (AppSettings.game == GD.IDGame.JK3)
				|| (AppSettings.game == GD.IDGame.Hexen)|| (AppSettings.game == GD.IDGame.Strife)|| (AppSettings.game == GD.IDGame.Heretic)) //If doom, hide the music and other options, now alos Q3!
