...
class SDLMain implements Runnable {
    @Override
    public void run() {
        OpenTouchSDL.launch( SDLActivity.mSingleton.getIntent(), (int)SDLActivity.mSurface.mWidth, (int)SDLActivity.mSurface.mHeight,
                SDLActivity.mSingleton.getContext().getApplicationInfo().nativeLibraryDir );
        /*
        // Runs SDL_main()
