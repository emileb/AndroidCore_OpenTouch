...
public class SDLSurface extends SurfaceView implements SurfaceHolder.Callback,
    ...
    public void surfaceChanged(SurfaceHolder holder,
        ...
        if( SDLOpenTouch.surfaceChanged(SDLActivity.mSingleton, holder, width, height) == true)
            return;
    ...
    public boolean onTouch(View v, MotionEvent event) {
        ...
        do {
            ...
            if (toolType == MotionEvent.TOOL_TYPE_MOUSE && !SDLActivity.OPENTOUCH_SDL_EXTRA) {
            ...
            } else if(SDLActivity.OPENTOUCH_SDL_EXTRA) {
    ...
    public boolean onCapturedPointerEvent(MotionEvent event)
    {
        ...
        if(SDLActivity.OPENTOUCH_SDL_EXTRA == true) // Consume all events, otherwise onKey events get produced on mouse buttons
            return true;
